                        ...
                        <div className="col-lg-8">
                            ...
                            <div className="bg-white border border-top-0 p-4 mb-3">
                                <div className="mb-4">
                                    ...
                                    <p className="mb-4">For inquiries, tips, or corrections related to WorldBeat news articles, please reach out to our editorial team. We value your feedback and strive for accuracy. Contact us via email at support@sugimx.com or call us at +91 89033 01652 during business hours. Your voice helps shape better journalism..</p>
                                    <div className="mb-3">
                                        <div className="d-flex align-items-center mb-2">
                                            <i className="fa fa-map-marker-alt text-primary mr-2"></i>
                                            <h6 className="font-weight-bold mb-0">Our Office</h6>
                                        </div>
                                        <p className="m-0">86, Parakkai Road, Keezhavannanvilai, Nagercoil-2 629501</p>
                                    </div>
                                    <div className="mb-3">
                                        <div className="d-flex align-items-center mb-2">
                                        ...
                                        <a className="m-0 contact--info" href="mailto:support@sugimx.com">support@sugimx.com</a>
                                    </div>
                                    <div className="mb-3">
                                        <div className="d-flex align-items-center mb-2">
                                        ...
                                        <a className="m-0 contact--info" href="tel:+918903301652">+91 8903301652</a>
                                    </div>
                                </div>
